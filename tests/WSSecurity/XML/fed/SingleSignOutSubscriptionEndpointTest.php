...
/**
 * Tests for fed:SingleSignOutSubscriptionEndpoint.
 *
 * @covers \SimpleSAML\WSSecurity\XML\fed\SingleSignOutSubscriptionEndpoint
 * @covers \SimpleSAML\WSSecurity\XML\fed\AbstractEndpointType
 * @covers \SimpleSAML\WSSecurity\XML\fed\AbstractFedElement
 * @package tvdijen/ws-security
 */
final class SingleSignOutSubscriptionEndpointTest extends TestCase
{
    ...
    {
        self::$testedClass = SingleSignOutSubscriptionEndpoint::class;

        self::$schemaFile = dirname(__FILE__, 5) . '/resources/schemas/ws-federation.xsd';

        self::$xmlRepresentation = DOMDocumentFactory::FromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed_SingleSignOutSubscriptionEndpoint.xml'
        );
    ...
    /**
     * Test creating an SingleSignOutSubscriptionEndpoint object from scratch.
     */
    public function testMarshalling(): void
    {
        ...
        $singleSignOutSubscriptionEndpoint = new SingleSignOutSubscriptionEndpoint([$endpointReference]);

        $this->assertEquals(
            self::$xmlRepresentation->saveXML(self::$xmlRepresentation->documentElement),
            strval($singleSignOutSubscriptionEndpoint),
        );
    }
    ...
    {
        $singleSignOutSubscriptionEndpoint = SingleSignOutSubscriptionEndpoint::fromXML(
