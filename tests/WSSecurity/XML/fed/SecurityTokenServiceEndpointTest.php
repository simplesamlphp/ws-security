...
/**
 * Tests for fed:SecurityTokenServiceEndpoint.
 *
 * @covers \SimpleSAML\WSSecurity\XML\fed\SecurityTokenServiceEndpoint
 * @covers \SimpleSAML\WSSecurity\XML\fed\AbstractEndpointType
 * @covers \SimpleSAML\WSSecurity\XML\fed\AbstractFedElement
 * @package tvdijen/ws-security
 */
final class SecurityTokenServiceEndpointTest extends TestCase
{
    ...
    {
        self::$testedClass = SecurityTokenServiceEndpoint::class;

        self::$schemaFile = dirname(__FILE__, 5) . '/resources/schemas/ws-federation.xsd';

        self::$xmlRepresentation = DOMDocumentFactory::FromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed_SecurityTokenServiceEndpoint.xml'
        );
    ...
    /**
     * Test creating an SecurityTokenServiceEndpoint object from scratch.
     */
    public function testMarshalling(): void
    {
        ...
        $securityTokenServiceEndpoint = new SecurityTokenServiceEndpoint([$endpointReference]);
