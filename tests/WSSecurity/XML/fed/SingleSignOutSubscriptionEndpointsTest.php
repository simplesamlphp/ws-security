...
/**
 * Tests for fed:SingleSignOutSubscriptionEndpoints.
 *
 * @covers \SimpleSAML\WSSecurity\XML\fed\SingleSignOutSubscriptionEndpoints
 * @covers \SimpleSAML\WSSecurity\XML\fed\AbstractEndpointType
 * @covers \SimpleSAML\WSSecurity\XML\fed\AbstractFedElement
 * @package simplesamlphp/ws-security
 */
final class SingleSignOutSubscriptionEndpointsTest extends TestCase
{
    ...
    {
        self::$testedClass = SingleSignOutSubscriptionEndpoints::class;

        self::$schemaFile = dirname(__FILE__, 5) . '/resources/schemas/ws-federation.xsd';

        self::$xmlRepresentation = DOMDocumentFactory::FromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed_SingleSignOutSubscriptionEndpoints.xml'
        );
    ...
    /**
     * Test creating an SingleSignOutSubscriptionEndpoints object from scratch.
     */
    public function testMarshalling(): void
    {
        ...
        $singleSignOutSubscriptionEndpoints = new SingleSignOutSubscriptionEndpoints([$endpointReference]);

        $this->assertEquals(
            self::$xmlRepresentation->saveXML(self::$xmlRepresentation->documentElement),
            strval($singleSignOutSubscriptionEndpoints),
        );
    }
}
