...
use SimpleSAML\WSSecurity\XML\fed\ApplicationServiceEndpoint;
...
final class ApplicationServiceEndpointTest extends TestCase
{
    ...
    /**
     * Test creating an ApplicationServiceEndpoint object from scratch.
     */
    public function testMarshalling(): void
    {
        ...
        $applicationServiceEndpoint = new ApplicationServiceEndpoint([$endpointReference]);
