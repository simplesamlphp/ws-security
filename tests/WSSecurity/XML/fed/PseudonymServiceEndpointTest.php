...
/**
 * Tests for fed:PseudonymServiceEndpoint.
 *
 * @covers \SimpleSAML\WSSecurity\XML\fed\PseudonymServiceEndpoint
 * @covers \SimpleSAML\WSSecurity\XML\fed\AbstractEndpointType
 * @covers \SimpleSAML\WSSecurity\XML\fed\AbstractFedElement
 * @package tvdijen/ws-security
 */
final class PseudonymServiceEndpointTest extends TestCase
{
    ...
    {
        self::$testedClass = PseudonymServiceEndpoint::class;

        self::$schemaFile = dirname(__FILE__, 5) . '/resources/schemas/ws-federation.xsd';

        self::$xmlRepresentation = DOMDocumentFactory::FromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed_PseudonymServiceEndpoint.xml'
        );
    ...
    /**
     * Test creating an PseudonymServiceEndpoint object from scratch.
     */
    public function testMarshalling(): void
    {
        ...
        $pseudonymServiceEndpoint = new PseudonymServiceEndpoint([$endpointReference]);

        $this->assertEquals(
            self::$xmlRepresentation->saveXML(self::$xmlRepresentation->documentElement),
            strval($pseudonymServiceEndpoint),
        );
    }
}
