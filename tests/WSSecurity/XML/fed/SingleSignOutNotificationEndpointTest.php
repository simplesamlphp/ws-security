...
final class SingleSignOutNotificationEndpointTest extends TestCase
{
    ...
    {
        self::$testedClass = SingleSignOutNotificationEndpoint::class;

        self::$schemaFile = dirname(__FILE__, 5) . '/resources/schemas/ws-federation.xsd';

        self::$xmlRepresentation = DOMDocumentFactory::FromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed_SingleSignOutNotificationEndpoint.xml',
        );
    ...
    /**
     * Test creating an SingleSignOutNotificationEndpoint object from scratch.
     */
    public function testMarshalling(): void
    {
        ...
        $singleSignOutNotificationEndpoint = new SingleSignOutNotificationEndpoint([$endpointReference]);
