...
/**
 * Tests for fed:AttributeServiceEndpoints.
 *
 * @covers \SimpleSAML\WSSecurity\XML\fed\AttributeServiceEndpoints
 * @covers \SimpleSAML\WSSecurity\XML\fed\AbstractEndpointType
 * @covers \SimpleSAML\WSSecurity\XML\fed\AbstractFedElement
 * @package tvdijen/ws-security
 */
final class AttributeServiceEndpointsTest extends TestCase
{
    ...
    {
        self::$testedClass = AttributeServiceEndpoints::class;

        self::$schemaFile = dirname(__FILE__, 5) . '/resources/schemas/ws-federation.xsd';

        self::$xmlRepresentation = DOMDocumentFactory::FromFile(
            dirname(__FILE__, 4) . '/resources/xml/fed_AttributeServiceEndpoints.xml'
        );
    ...
    /**
     * Test creating an AttributeServiceEndpoints object from scratch.
     */
    public function testMarshalling(): void
    {
        ...
        $attributeServiceEndpoints = new AttributeServiceEndpoints([$endpointReference]);

        $this->assertEquals(
            self::$xmlRepresentation->saveXML(self::$xmlRepresentation->documentElement),
            strval($attributeServiceEndpoints),
        );
    }
}
