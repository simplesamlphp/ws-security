...
use SimpleSAML\WSSecurity\XML\wst\RequestKET;
...
/**
 * Class \SimpleSAML\WSSecurity\XML\wst\RequestKETTest
 *
 * @covers \SimpleSAML\WSSecurity\XML\wst\RequestKET
...
final class RequestKETTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/wst_RequestKET.xml',
        );
    }
