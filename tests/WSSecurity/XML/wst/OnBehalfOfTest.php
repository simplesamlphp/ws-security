...
use SimpleSAML\WSSecurity\XML\wst\OnBehalfOf;
...
/**
 * Class \SimpleSAML\WSSecurity\XML\wst\OnBehalfOfTest
 *
 * @covers \SimpleSAML\WSSecurity\XML\wst\OnBehalfOf
 * @covers \SimpleSAML\WSSecurity\XML\wst\AbstractOnBehalfOfType
...
final class OnBehalfOfTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/wst_OnBehalfOf.xml',
        );
    }
